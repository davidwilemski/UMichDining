		...
		super.onCreate(savedInstanceState);
		 ...
		 lv.setOnItemClickListener(new OnItemClickListener(){
			 public void onItemClick(AdapterView<?> parent, View view, int position, long id)
			 {
				 ...
				 try {
					 Cursor c = dbMod.getLocationMeal(NorthCampus[position], "2010-11-02", "breakfast");
					 String b, l, d;
					 if(c.moveToFirst()) {
						 b = c.getString(0);
					 } else {
					 ...
					 c = dbMod.getLocationMeal(NorthCampus[position], "2010-11-02", "lunch");
					 if(c.moveToFirst()) {
						 l = c.getString(0);
					 } else {
						 l = "[\"No Menu Avaliable\"]";
					 ...
					 c = dbMod.getLocationMeal(NorthCampus[position], "2010-11-02", "dinner");
					 if(c.moveToFirst()) {
						 d = c.getString(0);
					 } else {
						 d = "[\"No Menu Avaliable\"]";
